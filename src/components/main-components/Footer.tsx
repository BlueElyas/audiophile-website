    ...
    return(
        <>
            <div className="bg-black text-white flex flex-col justify-center items-center text-center gap-10 px-6 
                            md:items-start md:text-start xl:px-[10rem] ">
                <div className="border-[#D87D4A] border-2 w-28"></div>

                    <div className="flex flex-col gap-6 xl:flex-row xl:w-full xl:justify-between">
                        <div className="">
                            <Logo/>
                        </div>
                ...
                <p className="opacity-50 md:w-1/2 ">Audiophile is an all in one stop to fulfill your audio needs. We're a small 
                ...
                <div className="mb-16 flex flex-col justify-center items-center gap-8 w-full md:flex-row md:justify-between">
