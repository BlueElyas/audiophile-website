...
export function Zx9Speaker() {
    ...
    return(
        <div className="bg-[#D87D4A] text-white text-center h-[600px] 
            ...
            py-4 md:relative overflow-hidden xl:justify-center xl:items-end xl:mx-[11.5rem]">
            <div className="relative md:absolute overflow-hidden z-30 xl:static ">
                ...
                <img 
                    ...
                    className="absolute w-30 h-40 top-16 left-16 md:bottom-[40%] md:top-auto md:left-96 
                                xl:left-12 xl:w-[24rem] xl:h-[30rem] xl:-bottom-2"
                />
            </div>
            <div className="flex flex-col justify-center items-center gap-6 xl:text-start xl:items-start xl:absolute xl:-right-96">
