        ...
        <>
            <div className="relative text-white text-center">
                ...
                <div className="absolute top-20  uppercase grid gap-8 ">
                    ...
                    <SeeProductButton style="bg-[#D87D4A] w-2/3 place-self-center" onClick={() => {}}/>
            ...
            <div className="bg-[#D87D4A] text-white text-center h-[600px] 
                ...
                <SeeProductButton style="bg-black mb-8" onClick={() => {}}/>
            </div>
            ...
            <div className="relative px-6 mt-4 mb-4 ">
                ...
                <div className="absolute top-24 ml-7">
                    ...
                    <SeeProductButton style="border-black border-[1px] font-bold" onClick={() => {}}/>
                </div>
            </div>
